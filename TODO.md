...
- [ ] Rotate OpenAI API key (old one was in git history)
...
- [ ] Start a text-mode call from the dashboard
- [ ] Chat as the student and watch the agent respond
...
- [ ] Add WebSocket support for browser-based voice (mic input -> OpenAI Realtime)
